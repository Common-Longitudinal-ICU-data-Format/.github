...
3. [CLIFATRON](https://github.com/Common-Longitudinal-ICU-data-Format/CLIFATRON)
4. [Differential Severity: PaO2/FiO2 vs SpO2/FiO2 in Acute Hypoxemic Respiratory Failure](https://github.com/Common-Longitudinal-ICU-data-Format/CLIF_PFvsSF_Performance)
5. [Effect of Nocturnal Sedation on SBT Performance and Extubation](https://github.com/Common-Longitudinal-ICU-data-Format/CLIF-epi-of-sedation)
6. [Eligibility for Mobilization](https://github.com/Common-Longitudinal-ICU-data-Format/CLIF-eligibility-for-mobilization)
7. [Epidemiology of Code Status Orders Across CLIF Sites](https://github.com/p-lyons/clif_code_status)
8. [Epidemiology of CRRT](https://github.com/Common-Longitudinal-ICU-data-Format/CLIF-epidemiology-of-CRRT)
...
#### 🔬 **Projects** (cont.)
----
15. [Proning Incidence in Severe ARF](https://github.com/Common-Longitudinal-ICU-data-Format/CLIF_Proning_Incidence_Severe_ARF)
16. [Resistance Patterns of Pseudomonas Aeruginosa in Critically Ill Adults](https://github.com/Common-Longitudinal-ICU-data-Format/Pseudomonas-Resistance-Patterns-in-the-United-States-A-Seven-Year-Review)
17. [Respiratory Failure Environmental Risk (REFER) in ICU Patients](https://github.com/petergraffy/CLIF-REFER)
18. [Role of Treatment Setting in Acute Respiratory Failure](https://github.com/Common-Longitudinal-ICU-data-Format/ARF-NIV_TreatmentLocation)
19. [Rule-Based SAT Comparison](https://github.com/Common-Longitudinal-ICU-data-Format/CLIF_rule-based-SAT-comparison)
20. [Rule-Based SAT/SBT Signature Detection](https://github.com/Common-Longitudinal-ICU-data-Format/CLIF_rule_based_SAT_SBT_signature)
